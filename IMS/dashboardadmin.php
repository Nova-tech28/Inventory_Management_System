                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-16"><strong><a href="files/deptsetup.php">DEPARTMENT SETUP</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="files/deptsetup.php"><img src="assets/img/banner/ad1.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="files/staffaccess.php"><img src="assets/img/banner/ad2.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="dashboardcheck.php">ACCOUNT MENU</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="dashboardcheck.php"><img src="assets/img/banner/ad3.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="files/inventory.php">INVENTORY</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="files/inventory.php"><img src="assets/img/banner/ad4.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
