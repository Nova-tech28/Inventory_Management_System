...
//=======get the no of users
$sql="SELECT * FROM user_details WHERE clientid='$clientid' and user_email='$user_email'";
...
$deptkeep = $rowval['department'];

}
//-----------------------
$sql1="SELECT * FROM supply1 WHERE clientid='$clientid' and confirmby='$username'";
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">Department</h5>
                          <h2 class="mb-3 font-13"><?php echo $deptkeep ;  ?></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/ad1.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">No of Orders</h5>
                          <h2 class="mb-3 font-13"><a href="files/ordercheck.php"><?php echo $count1 ;  ?></a></h2>
                          
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/d4.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
