                ...
                <div class="card card-statistic-2">
                  ...
                  <div class="card-wrap">
                    ...
                    <div class="card-body pull-right">
                      <img src="plus.png"> =N=<?php echo count_total_order_value($connect); ?>
                    </div>
                  </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                  ...
                  <div class="card-wrap">
                    ...
                    <div class="card-body pull-right">
                     <img src="plus.png"> =N=<?php echo count_total_cash_order_value($connect); ?>
                    </div>
                  </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="card card-statistic-2">
                  ...
                  <div class="card-wrap">
                    ...
                    <div class="card-body pull-right">
                     <img src="plus.png"> =N=<?php echo count_total_credit_order_value($connect); ?>
                    </div>
                  </div>
