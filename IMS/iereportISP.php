...
//====income trading-------
$result1 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM trading WHERE date1='$datekeep' and clientid='$clientid'"); 
...
//------------------------------------
//====income data-------
$result3 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM datainfo1 WHERE date1='$datekeep' and clientid='$clientid'"); 
$row3 = mysqli_fetch_assoc($result3); 
$sum3 = $row3['value_sum'];
//------------------------------------
//====income airtime-------
$result4 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM airtime_info WHERE date1='$datekeep' and clientid='$clientid'"); 
$row4 = mysqli_fetch_assoc($result4); 
$sum4 = $row4['value_sum'];
//------------------------------------
//====income cabletv-------
$result5 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM cabletv WHERE date1='$datekeep' and clientid='$clientid'"); 
$row5 = mysqli_fetch_assoc($result5); 
$sum5 = $row5['value_sum'];
//------------------------------------

//====Expense Accounting-------
$result6 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate='$datekeep' and dept = 'ACCOUNTING' and clientid='$clientid'"); 
$row6 = mysqli_fetch_assoc($result6); 
$sum6 = $row6['value_sum'];
//------------------------------------
//====Expense Operations-------
$result7 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate='$datekeep' and dept = 'OPERATIONS' and clientid='$clientid'"); 
