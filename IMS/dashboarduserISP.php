      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="link20.php"><i data-feather="layout"></i><span>Trading</span></a></li>
            <li><a class="nav-link" href="dashboardent.php"><i data-feather="layout"></i><span>ISP Enterprise</span></a></li>
            <li><a class="nav-link" href="link21.php"><i data-feather="layout"></i><span>Delivery</span></a></li>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="link20.php">TRADING</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="link20.php"><img src="assets/img/banner/d9.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="dashboardent.php">ISP ENTERPRISE</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="dashboardent.php"><img src="assets/img/banner/d10.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="link21.php">DELIVERY</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="link21.php"><img src="assets/img/banner/d11.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="link28.php">SAFE LOCK</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="link28.php"><img src="assets/img/banner/d14.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
