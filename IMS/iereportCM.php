...
//------------------------------------
//====income tradingbtc-------
$result3 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM  tradingbtc WHERE date1='$datekeep' and clientid='$clientid'"); 
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-inline" action="iereportdateCM.php">
