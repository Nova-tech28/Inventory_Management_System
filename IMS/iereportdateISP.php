...
//====income trading-------
$result1 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM trading WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
$row1 = mysqli_fetch_assoc($result1); 
$sum1 = $row1['value_sum'];
//------------------------------------
//====income gadget sales-------
$result2 = mysqli_query($conn,"SELECT SUM(totalprofit) AS value_sum FROM supply1 WHERE supplydate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
$row2 = mysqli_fetch_assoc($result2); 
$sum2 = $row2['value_sum'];
//------------------------------------
//====income data-------
$result3 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM datainfo1 WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
$row3 = mysqli_fetch_assoc($result3); 
$sum3 = $row3['value_sum'];
//------------------------------------
//====income airtime-------
$result4 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM airtime_info WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
$row4 = mysqli_fetch_assoc($result4); 
$sum4 = $row4['value_sum'];
//------------------------------------
//====income cabletv-------
$result5 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM cabletv WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
$row5 = mysqli_fetch_assoc($result5); 
$sum5 = $row5['value_sum'];
//------------------------------------

//====Expense Accounting-------
$result6 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and dept = 'ACCOUNTING' and clientid='$clientid'"); 
$row6 = mysqli_fetch_assoc($result6); 
$sum6 = $row6['value_sum'];
//------------------------------------
//====Expense Operations-------
$result7 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and dept = 'OPERATIONS' and clientid='$clientid'"); 
$row7 = mysqli_fetch_assoc($result7); 
$sum7 = $row7['value_sum'];
//------------------------------------

$totalincome = ($sum1 + $sum2 + $sum3 + $sum4 + $sum5);
$totalexpense = ($sum6 + $sum7);
        ...
        <section class="section">
          ...
          <div class="card">
            <div class="card-header">
                    <h4>Income and Expense Report between <?php echo $startdate . " and " .$enddate ;  ?> | <a href="files/placcount.php" >View Report Analysis</a></h4>
                  </div>
                  <div class="card-header">
                    <h4>Query by Date</h4>
                  </div>
                  <div class="card-body">
                    <form class="form-inline" action="iereportdateISP.php">
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">TRADING</h5>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/d9.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">GADGET SALES</h5>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">DATA SUB</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum3,2) ;?></h2>
                         
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/en2.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">AIRTIME SUB</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum4,2) ;?></h2>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">CABLETV SUB</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum5,2) ;?></h2>
                          
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/en3.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
 ...
 <div class="font-15 style1"><button type="button"  class="btn btn-primary">
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">ACCOUNTING</h5>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">OPERATIONS</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum7,2) ;?></h2>
                          
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/d6.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          <a href="#">Developed by Emmanex IT Consult</a></a>
        </div>
