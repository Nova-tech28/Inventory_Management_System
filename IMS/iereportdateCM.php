...
//------------------------------------
//====income data-------
$result3 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum FROM tradingbtc WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
...
//====Expense Accounting-------
$result6 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and clientid='$clientid'"); 
$row6 = mysqli_fetch_assoc($result6); 
$sum6 = $row6['value_sum'];
//------------------------------------

$totalincome = ($sum1 + $sum2 + $sum3);
$totalexpense = ($sum6);
?>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum1 + $sum3,2) ;?></h2>
