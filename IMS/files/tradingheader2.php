...
<html>
	...
	<body>
		<br />
		<div class="container">
			<h2 align="center">BTC/USDT TRADING</h2>
			...
			<nav class="navbar navbar-inverse">
				<div class="container-fluid">
                    ...
                    <li><a href="tradeid2.php">New Trading </a></li>
											<li><a href="tprofitaccountcheck2.php">Profit Analysis </a></li>
											<li><a href="edittrdcheck1.php">Edit Transaction </a></li>
                     						 <li><a href="edittrdcheck2.php">Confirm Transaction </a></li>
