...
?>
        ...
        <div class="modal-body">
          ...
          <div class="form-group style5">
            ...
            <span class="form-group style8 style5"><?php echo $itemsupplier; ?></span></div>
            <div class="form-group style5">
            <label>Cashier :</label>
        ...
        <div class="modal-footer">
          ...
          <input name="button1" type="submit" id="button1"  class="hidden-print" onclick="MM_goToURL('parent','itemsearchcheck.php');return document.MM_returnValue" value="Close" />
        </div>
      </div></td>
      <td width="97">&nbsp;</td>
    </tr>
