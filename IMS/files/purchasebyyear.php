...
<form id="form1" name="form1" method="post" action="">
  <table width="60%" border="0" align="left" class="table table-bordered table-striped">
    <tr>
      <td colspan="2"><span class="style1"><a href="purchasecsv2.php">Download CSV</a> for  <span class="style6"><?php echo $month1keep . " ".$year1keep;  ?> <span class="style7">| <a href="purchase.php">Menu</a></span></span></span></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
...
$sql = "SELECT itemname,itemsupplier,itemquantity,itemunit,amount,purchasedate,paymentmode FROM purchase WHERE  month1='$month1keep' and year1='$year1keep'and clientid='$clientid'  order by purchasedate ASC";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM purchase WHERE  month1='$month1keep' and year1='$year1keep'and clientid='$clientid' ";
