...
$sql = "SELECT itemname,amount,purchasedate,paymentmode FROM purchase1 WHERE  month1='$month1keep' and year1='$year1keep'and clientid='$clientid'  order by purchasedate ASC";
