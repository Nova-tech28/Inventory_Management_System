...
$sql="SELECT * FROM corder WHERE itembarcode='$itembarcode' and supplyid='$supplyid' and clientid='$clientid' ";
...
$sql1="DELETE FROM corder WHERE itembarcode='$itembarcode' and supplyid='$supplyid' and clientid='$clientid'";
