                ...
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Add Airtime</h4>
                        </div>
            ...
            <div class="modal-dialog">
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Airtime Details</h4>
                        </div>
                        <div class="modal-body">
...
$(document).ready(function(){
    ...
    $('#add_button').click(function(){
        ...
        $('.modal-title').html("<i class='fa fa-plus'></i> Add Airtime Info");
        $('#action').val("Add");
        $('#btn_action').val("Add");
    });
        ...
        $.ajax({
            ...
            success:function(data){
               $('#productModal').modal('show');
                ...
                $('.modal-title').html("<i class='fa fa-pencil-square-o'></i> Edit Airtime info");
