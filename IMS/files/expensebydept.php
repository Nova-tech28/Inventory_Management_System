...
$sql = "SELECT itemname,amount,purchasedate,paymentmode FROM purchase1 WHERE  dept='$deptkeep' and clientid='$clientid'  order by purchasedate ASC";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM purchase1 WHERE  dept='$deptkeep' and clientid='$clientid' ";
...
echo "<table class='table table-bordered table-striped'><thead><tr><th>S/NO</th><th>ITEM NAME</th><th>AMOUNT</th><th>DATE</th><th>PAYMENT MODE</th></tr></thead>";
	 ...
	 //$c++ ;
         echo "<tr><td>" . ++$c. "</td><td>" . $row["itemname"]. "</td><td>"  . $row["amount"]. "</td><td>"  . $row["purchasedate"]. "</td><td>"  . $row["paymentmode"]. "</td></tr>";
