...
if($_POST['btn_action'] == 'Add')
	{
		$query = "
		INSERT INTO purchase1 (itemname, itemsupplier, itemquantity,amount,paymentmode,approvedby,purchasedate,clientid,itemunit,confirmby,status,comment,dept,month1,year1,purchaseid,user_id) 
...
$narration = "Expense : " . $itemquantity . $itemunit .  " " . $itemname ;
