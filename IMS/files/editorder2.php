    ...
    <tr>
      <td width="550"><div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="fa fa-plus"></i> Order- <?php echo $supplyid ; ?></h4>
        </div>
         <div class="modal-body">
         <?php

//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql = "SELECT rid,itembarcode,itemname,itemquantity,amount,product_type,itemprice,itemim FROM supply WHERE  supplyid='$supplyid' and clientid='$clientid'  order by itemname ASC";
...
echo "<table class='table table-bordered table-striped'><thead><tr><th>S/NO</th><th>BARCODE</th><th>ITEM NAME</th><th>IMEI NO</th><th>TYPE</th><th>QUANTITY</th><th>RATE</th></th><th>AMOUNT</th></tr></thead>";
	 ...
	 //$c++ ;
         echo "<tr><td>" . ++$c. "</td><td>" . $row["itembarcode"]. "</td><td>" . $row["itemname"]. "</td><td>" . $row["itemim"]. "</td><td>" . $row["product_type"]. "</td><td>" . $row["itemquantity"]. "</td><td>"  . $row["itemprice"]. "</td><td>"  . $row["amount"]. "</td></tr>";
...
?>
          ...
          <div class="form-group">
            <table width="50%" border="0" cellpadding="4" cellspacing="4" class='table table-bordered table-striped'>
              ...
              <tr>
                ...
                <td><p><span class="style6"><?php echo $paymentmode;  ?></span> </p>
                  </td>
              </tr>
              <tr>
                ...
                <td><span class="style5 style8">
                  <label></label>
                </span><p class="style5 style8"> <span class="style6"><?php echo $paymentstatus;  ?></span></p></td>
              </tr>
              <tr>
                <td height="58"><span class="style8 style5"><strong>
                  <label>Comment</label>
        ...
        <div class="modal-footer">
          <input name="button" type="submit" id="button"  class="btn btn-info" onclick="MM_goToURL('parent','aconfirmorder.php');return document.MM_returnValue" value="Close" />
        </div>
      </div></td>
      <td width="37">&nbsp;</td>
    </tr>
