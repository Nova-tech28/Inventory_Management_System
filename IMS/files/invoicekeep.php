...
//$timekeep = date('h:i A', strtotime($currentDateTime));
...
?>
        ...
        <div class="modal-body">
          <div class="form-group">
            <table width="50%" border="0" cellpadding="4" cellspacing="4" class='table table-bordered table-striped'>
              ...
              <tr>
                <td><span class="style11">Tendered</span></td>
                <td><span class="style9 style8"><?php echo $finalamount; ?></span></td>
              </tr>
              <tr>
                <td><span class="style11">Customer Name</span></td>
                <td><span class="form-group style8 style5"><?php echo $itemsupplier; ?></span></td>
              </tr>
              <tr>
        ...
        <div class="modal-footer">
          <input name="button" type="submit" id="button"  class="btn btn-info" onclick="MM_goToURL('parent','supplylogin.php');return document.MM_returnValue" value="Close" />
        </div>
      </div></td>
      <td width="58">&nbsp;</td>
    </tr>
