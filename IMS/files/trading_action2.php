...
if($_POST['btn_action'] == 'Add')
	...
	$profit = ($totalamount_cl - $totalamount_cus);
		$query = "
		INSERT INTO tradingbtc (crypto_name, dollar_value,frac_value, customer_rate,selling_rate,customer_name,mobile_no,totalamount_cus,totalamount_cl,profit,date1,time1,confirm_by,clientid,tradeid,status,transstatus) 
		VALUES (:crypto_name, :dollar_value,:frac_value, :customer_rate,:selling_rate,:customer_name,:mobile_no,:totalamount_cus,:totalamount_cl,:profit,:date1,:time1,:confirm_by,:clientid,:tradeid,:status,:transstatus)
		";	
