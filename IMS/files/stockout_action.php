...
if($_POST['btn_action'] == 'Add')
	{
		$query = "
		INSERT INTO product (category_name, product_name, product_description,product_quantity,product_unit,product_base_price,product_sell_price,product_barcode,product_type,product_enter_by,product_status,product_date,clientid,user_id) 
		VALUES (:category_name, :product_name, :product_description,:product_quantity,:product_unit,:product_base_price,:product_sell_price,:product_barcode,:product_type,:product_enter_by,:product_status,:product_date,:clientid,:user_id)
		";	
