...
$result = mysqli_query($conn,"SELECT SUM(credit) AS value_sum FROM profitloss WHERE clientid='$clientid' AND transstatus = 'Active'"); 
$row = mysqli_fetch_assoc($result); 
$sum = $row['value_sum'];


//=========================
$result1 = mysqli_query($conn,"SELECT SUM(debit) AS value_sum1 FROM profitloss WHERE clientid='$clientid' AND transstatus = 'Active'"); 
                      ...
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_creditorder_valuepl($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          <div class="panel-heading"><strong>Total Expense</strong></div>
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_debitorder_valuepl($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          <div class="panel-heading"><strong>Difference</strong></div>
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo $diffkeep; ?></h1>
                          </div>
                        </div>
                      </div>
                      <hr />
