...
<div class="row"></div>
<form method="post" id="product_form" action="discountcal.php">
  <table width="597" border="0">
    <tr>
      <td width="550"><div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><i class="fa fa-plus"></i> Discount - <?php echo $supplyid ; ?></h4>
        </div>
...
echo "<table class='table table-bordered table-striped'><thead><tr><th>S/NO</th><th>BARCODE</th><th>ITEM NAME</th><th>QUANTITY</th><th>RATE</th><th>AMOUNT</th><th></th></tr></thead>";
	 ...
	 //$c++ ;
         echo "<tr><td>" . ++$c. "</td><td>" . $row["itembarcode"]. "</td><td>" . $row["itemname"]. "</td><td>" . $row["itemquantity"]. "</td><td>" . $row["itemprice"]. "</td><td>"  . $row["amount"]. "</td></tr>";
...
?>
          ...
          <table width="50%" border="0" cellpadding="4" cellspacing="4" class='table table-bordered table-striped'>
              ...
              <tr>
                <td><span class="style8 style5"><strong>Total Amount</strong></span></td>
              ...
              <tr>
                ...
                <td><select name="discount" class="form-control style6 style8 style8" id="discount" required="required">
        ...
        <div class="modal-footer">
          <input type="submit" name="action" id="action" class="btn btn-info" value="Give Discount" />
           <input name="button" type="submit" id="button"  class="btn btn-info" onclick="MM_goToURL('parent','checkout.php');return document.MM_returnValue" value="Back to Cart" />
          <input name="button" type="submit" id="button"  class="btn btn-info" onclick="MM_goToURL('parent','supplyid.php');return document.MM_returnValue" value="Close" />
        </div>
      </div></td>
      <td width="37">&nbsp;</td>
    </tr>
