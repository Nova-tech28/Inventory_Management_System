...
$sql = "SELECT product_id,customer_rate,amount_sold,vendor_name,customer_name,card_name,card_amount,card_rate,rmb_value,profit,date1 FROM trading WHERE  year1='$yearkeep' and clientid='$clientid'  order by date1 DESC";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM trading WHERE  year1='$yearkeep' and clientid='$clientid' ";
...
$result5 = mysqli_query($conn,"SELECT SUM(amount_sold) AS value_sum FROM trading WHERE year1='$yearkeep' and clientid='$clientid'"); 
...
//----------------get total profit-----------------
$result7 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum1 FROM trading WHERE year1='$yearkeep' and clientid='$clientid'"); 
