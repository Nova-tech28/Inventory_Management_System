...
$sql = "SELECT rid,itemname,itemquantity,amount,itemprice,product_profit,itembaseprice,confirmby,supplydate FROM supply WHERE  year1='$yearkeep' and confirmby='$transname' and  clientid='$clientid'  order by supplydate DESC";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM supply WHERE  year1='$yearkeep' and confirmby='$transname' and  clientid='$clientid' ";
...
$result5 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM supply WHERE year1='$yearkeep' and  confirmby='$transname' and  clientid='$clientid'"); 
...
//----------------get total profit-----------------
$result7 = mysqli_query($conn,"SELECT SUM(product_profit) AS value_sum1 FROM supply WHERE year1='$yearkeep' and confirmby='$transname' and  clientid='$clientid'"); 
