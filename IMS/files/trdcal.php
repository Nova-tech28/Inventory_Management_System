...
<div class="row"></div>
<form method="post" id="product_form" action="trdcheck.php">
  <table width="100%" border="0">
    <tr>
      <td width="322"><div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><i class="fa fa-plus"></i>TRADING CALCULATOR</h4>
        </div>
         ...
         <div class="modal-body">
          <div class="form-group">
            ...
            <p>
              <select name="trdtype" id="trdtype" onchange="MM_jumpMenu('parent',this,0)" class="form-control">
                <option>RMB/USDT RATE</option>
                <option>NAIRA RATE</option>
              </select></p>
            </div>
          </div>
