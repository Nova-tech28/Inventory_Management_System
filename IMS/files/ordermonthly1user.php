                      ...
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_order_valuemonthlyuser($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_cash_order_valuemonthlyuser($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_credit_order_valuemonthlyuser($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <hr />
...
<script type="text/javascript">
    $(document).ready(function(){
    	...
    	var orderdataTable = $('#order_data').DataTable({
			...
			"order":[],
			"ajax":{
				url:"order_fetchmonthlyuser.php",
				type:"POST"
			},
			<?php
			if($_SESSION["type"] == 'master')
