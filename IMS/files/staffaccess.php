	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('#checkbox9').val(data.checkbox9);
				$('#checkbox10').val(data.checkbox10);
				$('#checkbox11').val(data.checkbox11);                
