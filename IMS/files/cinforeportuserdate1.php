...
$sql = "SELECT product_id,customername,mobileno,iucno,cablename,cableplan,costprice,sellprice,profit,date1,confirmby FROM cabletv WHERE  date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and confirmby='$transname' and  clientid='$clientid'  order by date1 DESC";
...
$result5 = mysqli_query($conn,"SELECT SUM(sellprice) AS value_sum FROM cabletv WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and confirmby='$transname' and  clientid='$clientid'"); 
...
//----------------get total profit-----------------
$result7 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum1 FROM cabletv WHERE date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and confirmby='$transname' and  clientid='$clientid'"); 
