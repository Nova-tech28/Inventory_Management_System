                      ...
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_order_valueyearly($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_cash_order_valueyearly($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_credit_order_valueyearly($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <hr />
