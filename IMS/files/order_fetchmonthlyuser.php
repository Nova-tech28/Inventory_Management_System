...
supplydate = '".$_SESSION['datekeep1']."' AND  clientid = '".$_SESSION['clientid']."' AND month1 = '".$_SESSION['monthkeep']."' AND confirmby = '".$_SESSION['user_name']."' AND year1 = '".$_SESSION['yearkeep']."'");
	$statement->execute();
