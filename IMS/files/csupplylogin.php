...
<div class="row"></div>
<form method="post" id="product_form" action="csupplylogin1.php">
        ...
        <div class="modal-header">
         ...
         <div class="modal-body">
          <div class="form-group">
            <label>Customer Mobile No</label><p>
              <input name="mobileno" type="text" class="form-control" id="mobileno" size="10"  />
            </p>
            <p>&nbsp;              </p>
          </div>
          <div class="form-group">
            <label>If the customer has not been registered, <a href="customersetup.php" target="_blank">Click to Register</a></label>
          </div>
        </div>
