...
<div class="row"></div>
<form method="post" id="product_form" action="trdcal1.php">
        ...
        <div class="modal-header">
         ...
         <div class="modal-body">
          <div class="form-group">
            ...
            <p><strong>
              <input name="rate" type="text" class="form-control" id="rate" size="10" required="required" />
            </strong></p>
            <p><strong>RMB Rate</strong></p>
            <p><strong>
              <input name="rmbvalue" type="text" class="form-control" id="rmbvalue" size="10" required="required" />
            </strong></p>
