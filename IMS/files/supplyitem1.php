    ...
    <tr>
      <td><div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>IMEI No (If available)</label>
            <input name="itemim" type="text" class="form-control" id="itemim" value="" size="10"  />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Rebate (If available)</label>
            <input name="rebateval" type="text" class="form-control" id="rebateval" value="0" size="10" required="required" />
          </div>
        </div>
        <div class="modal-footer">
          <input type="submit" name="action" id="action" class="btn btn-info" value="Add" />
          
          <input name="button" type="submit" id="button"  class="btn btn-info" onclick="MM_goToURL('parent','supply.php');return document.MM_returnValue" value="Close" />
        </div>
      </div></td>
      <td>&nbsp;</td>
    </tr>
