...
$sql = "SELECT product_id,customer_name,mobile_no,network_type,network_value,price_bought,price_sold,profit,date1,confirm_by FROM datainfo1 WHERE  date1='$datekeep' and clientid='$clientid'  order by network_type ASC";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM datainfo1 WHERE  date1='$datekeep' and clientid='$clientid' ";
...
$result5 = mysqli_query($conn,"SELECT SUM(price_sold) AS value_sum FROM datainfo1 WHERE date1='$datekeep' and clientid='$clientid' "); 
...
//----------------get total profit-----------------
$result7 = mysqli_query($conn,"SELECT SUM(profit) AS value_sum1 FROM datainfo1 WHERE date1='$datekeep' and clientid='$clientid' "); 
