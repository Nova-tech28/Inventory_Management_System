...
$sql = "SELECT rid,itemname,itemquantity,amount,itemprice,product_profit,itembaseprice,confirmby,supplydate FROM supply WHERE  month1='$monthkeep' and year1='$yearkeep' and clientid='$clientid'  order by supplydate DESC";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM supply WHERE  month1='$monthkeep' and year1='$yearkeep' and clientid='$clientid' ";
