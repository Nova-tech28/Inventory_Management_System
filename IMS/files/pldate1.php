...
$paymentstatuskeep = $_REQUEST['paymentstatus'];
$_SESSION['paymentstatuskeep'] = $paymentstatuskeep;
    ...
    <tr>
      <td width="322"><div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="fa fa-plus"></i> Income / Expenditure - <?php echo $paymentstatuskeep ; ?></h4>
        </div>
