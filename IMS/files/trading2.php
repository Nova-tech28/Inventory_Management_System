                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="crypto_name" id="crypto_name" class="form-control" required />
                            </div>
                             <div class="form-group">
                                <label>Dollar Value</label>
                                <input type="text" name="dollar_value" id="dollar_value" class="form-control" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                            </div> 
                            
                           <div class="form-group">
                                <label>Fraction</label>
                                <input type="text" name="frac_value" id="frac_value" class="form-control" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="selling_rate" id="selling_rate" class="form-control" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                            </div>
                                   <div class="form-group">
    ...
    $(document).on('click', '.update', function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#dollar_value').val(data.dollar_value);
                $('#frac_value').val(data.frac_value);
