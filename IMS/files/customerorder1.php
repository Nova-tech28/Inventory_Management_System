	...
	?>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_order_valuecustomer($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_cash_order_valuecustomer($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center">
                            <h1>=N=<?php echo count_total_credit_order_valuecustomer($connect); ?></h1>
                          </div>
                        </div>
                      </div>
                      <hr />
        ...
        <div class="col-md-12">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="center"> <?php echo get_user_wise_total_ordercustomer($connect); ?> </div>
                        </div>
                      </div>
                      <?php
		}
