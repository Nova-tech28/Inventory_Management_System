...
foreach($result as $row)
{
	...
	$sub_array[] = $status;
	$sub_array[] = '<button type="button" name="update" id="'.$row["rid"].'" class="btn btn-warning btn-xs update">Approve & Edit</button>';
	$sub_array[] = '<button type="button" name="view" id="'.$row["rid"].'" class="btn btn-info btn-xs view">View</button>';
	$sub_array[] = '<a href="uploadpic.php?id='.$row["rid"].'" class="btn btn-info btn-xs">Upload Picture</a>';
