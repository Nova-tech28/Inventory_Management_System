...
<form id="form1" name="form1" method="post" action="ordercsvcheck.php">
  <table width="60%" border="0" align="left" class="table table-bordered table-striped">
    ...
    <tr>
      <td colspan="2"><select name="year2" id="year2"class="form-control">
        <option>2020</option>
        <option>2021</option>
        <option>2022</option>
        <option>2023</option>
    ...
    <tr>
      <td colspan="3"><span class="style1">Export by Month &amp; Year</span></td>
    </tr>
    <tr>
      <td colspan="3">&nbsp;</td>
    </tr>
