...
$sql="INSERT INTO user_details (user_email, user_password, user_name, user_type, clientid, user_status,ADM,AMG,PMG,WMG,CMG,HRG,RPT,SMG,TRD,DEL,TRDREP,DIS,REB,department,apptype,appabbrv)
VALUES
('$user_email','$user_password', '$applicantname','$user_type','$clientid','$user_status','$checkbox1','$checkbox2','$checkbox3','$checkbox4','$checkbox5','$checkbox6','$checkbox7','$checkbox8','$checkbox9','$checkbox11','$checkbox10','$checkbox12','$checkbox13','$dept','$apptype','$appabbrv')";
