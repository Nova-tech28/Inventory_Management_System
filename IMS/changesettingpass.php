                  ...
                  <form action="changesetting1.php" method="POST">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" id="oldpass" name="oldpass" class="form-control" required="" value="<?php echo $clientpass ; ?>">
                      </div>
                      <div class="form-group">
                        <label>New Password</label>
                        <input type="text" id="newpass" name="newpass" class="form-control" required="" value="">
                      </div>
