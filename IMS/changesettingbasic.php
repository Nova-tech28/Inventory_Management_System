          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <form action="changesetting1.php" method="POST">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" id="clientname" name="clientname" class="form-control" required="" value="<?php echo $clientname ; ?>">
                      </div>
                      <div class="form-group">
                        <label>Mobile No</label>
                        <input type="number" id="clientmobileno" name="clientmobileno" class="form-control" required="" value="<?php echo $clientmobileno ; ?>">
                      </div>
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" id="clientemail" name="clientemail"class="form-control" value="<?php echo $clientemail ; ?>">
                      </div>
                      <div class="form-group mb-0">
                        <label>Address</label>
                        <textarea id="address" name="address" class="form-control" required=""><?php echo $clientaddress ; ?></textarea>
                      </div>
                    </div>
                    <div class="card-footer text-right">
                      <input name="formtype" type="hidden" id="formtype" value="basic">
