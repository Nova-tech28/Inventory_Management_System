          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <form action="upgradeaccount1.php" method="POST">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <span class="style1"><strong><?php echo $clienttype; ?></strong></span>
                      </div>
                      <div class="form-group">
                        <label>Upgrade to</label>
                        <select name="clienttype" id="clienttype" class="mr-2 form-control" required>
                                                      <option>BASIC</option>
