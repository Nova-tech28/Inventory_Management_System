                  ...
                  <form>
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <a href="changesettingbasic.php" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit" ></i> Change Basic Information</a>
                      </div>
                      <div class="form-group">
                       <a href="changesettingpass.php" class="btn btn-icon icon-left btn-success"><i class="fas fa-check"></i> Change Password</a>
                      </div>
                      <div class="form-group">
                       <a href="changesettinglogo.php" class="btn btn-icon icon-left btn-dark"><i class="far fa-file"></i> Change Logo</a>
                      </div>
