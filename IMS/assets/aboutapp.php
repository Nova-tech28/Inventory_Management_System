                  ...
                  <form>
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <label></label>
                                                           <p align="justify">The  objective of IMS 3.0 is to deliver an efficient inventory management system  whose main functionality apart from calculating the inventory include  predicting the requirement for the next demand and if there is a “Special  Occasion” then accordingly the manager selects the particular occasion and  extra requirements is added to the next issuing order to the vendors which  needs to be approved by the manager. <br>
                                          The  product also aims to keep track of the shelf life of resources. If any resource  nears the end of its shelf life, it would acknowledge to the manager (admin)  the details of the quantity that is near its expiration date. <br>
                                          The  success criteria depend on </p>
                                        <p align="justify">* The accuracy in keeping the inventory levels </p>
                                        <p align="justify">* The accuracy in predicting the requirements of the next demand</p>
                                        <p align="justify">* The accuracy in relating recipes to their respective  constituents</p>
                                        <p align="justify">* Ease of use when it comes to updating inventory levels and  placing orders to vendors</p>
                                        <p align="justify"><span class="style3 style1">KEY FEATURES :<br>
- ADMIN <br>
